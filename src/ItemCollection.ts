...
import { ItemSheet5eSpellbook } from './module/ItemSheet5eSpellbook.js';
...
Hooks.once('init', async () => {
    ...
    Handlebars.registerHelper('formatSchoolsOfMagic', (school) => {
      const formatMap = {
        'evo': 'Evocation',
        'abj': 'Abjuration',
        'trs': 'Transmutation',
...
Hooks.once('setup', function () {
  ...
  //@ts-ignore
  Items.registerSheet(game.system.id, ItemSheet5eSpellbook, { makeDefault: false, types:["backpack"]});
